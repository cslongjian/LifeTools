...
public class CalPriceFactory {
    ...
    private static final String CAL_PRICE_PACKAGE = "com.cslong.app.lifetools.designpatterndemo.strategy.demo";//这里是一个常量，表示我们扫描策略的包
    ...
    //根据玩家的总金额产生相应的策略
    public CalPrice createCalPrice(Player2 player) {
        //在策略列表查找策略
