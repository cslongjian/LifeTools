package com.cslong.app.lifetools.designpatterndemo.create_pattern.builder;
...
public class BuilderDemo extends android.support.v4.app.DialogFragment {
    ...
    private View initDialogView() {
        View dialogView = LayoutInflater.from(getContext()).inflate(com.cslong.app.designpattern.R.layout.common_dialog_layout, null);
        if(TextUtils.isEmpty(title)){
            dialogView.findViewById(com.cslong.app.designpattern.R.id.title_view).setVisibility(View.GONE);
        }else{
            ((TextView) dialogView.findViewById(com.cslong.app.designpattern.R.id.title_view)).setText(title);
        }
        if(TextUtils.isEmpty(message)){
            dialogView.findViewById(com.cslong.app.designpattern.R.id.message_view).setVisibility(View.GONE);
        }else{
            ((TextView) dialogView.findViewById(com.cslong.app.designpattern.R.id.message_view)).setText(message);
        }
        TextView negativeButton = (TextView) dialogView.findViewById(com.cslong.app.designpattern.R.id.negative_button);
        TextView positiveButton = (TextView)dialogView.findViewById(com.cslong.app.designpattern.R.id.positive_button);
        View buttonDivider = dialogView.findViewById(com.cslong.app.designpattern.R.id.divider_view);
        TextView singleButton = (TextView)dialogView.findViewById(com.cslong.app.designpattern.R.id.single_button);
