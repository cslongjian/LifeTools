package com.cslong.app.lifetools.designpatterndemo.structure_pattern.proxy;
...
//        缺点：我们得为每一个服务都得创建代理类，工作量太大，不易管理。同时接口一旦发生改变，代理类也得相应修改。
        BuyHouse buyHouses = new BuyHouseImpl();
        buyHouses.buyHosue();
        BuyHouseProxy buyHouseProxy = new BuyHouseProxy(buyHouses);
...
//        动态代理总结：虽然相对于静态代理，动态代理大大减少了我们的开发任务，
